...
Provides functionality for managing files and directories in a workspace,
including creating, deleting, moving files, and searching file contents. It implements
a high-level interface to file system operations that can be performed within a
Daytona workspace.
...
class FileSystem:
    ...
    be performed within a Daytona workspace. It supports common operations like
    creating, deleting, and moving files, as well as searching file contents and
    managing permissions.

    Attributes:
        instance (WorkspaceInstance): The workspace instance this file system belongs to.
    ...
    def delete_file(self, path: str) -> None:
        ...
        This method permanently deletes a file from the workspace.
    ...
    def download_file(self, path: str) -> bytes:
        ...
        This method retrieves the contents of a file from the workspace.
    ...
    def search_files(self, path: str, pattern: str) -> SearchFilesResponse:
        """Search for files and directories matching a pattern in their names.
    ...
    def set_file_permissions(
        ...
        """Set permissions and ownership for a file or directory.
    ...
    def upload_file(self, path: str, file: bytes) -> None:
        ...
        This method uploads a file to the specified path in the workspace. The
        parent directory must exist. If a file already exists at the destination
        path, it will be overwritten.

        Args:
            path (str): Absolute destination path in the workspace.
