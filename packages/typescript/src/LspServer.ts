 ...
 * @module LspServer
 * 
 * @example Basic LSP server usage
 ...
 * 
 * @typedef {('python' | 'typescript' | 'javascript')} LspLanguageId
 */
export type LspLanguageId = 'python' | 'typescript' | 'javascript'
 ...
 * @property {ToolboxApi} toolboxApi - API client for workspace operations
 * @property {WorkspaceInstance} instance - The workspace instance this server belongs to
 */
