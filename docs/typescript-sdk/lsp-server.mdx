...
- `path` _string_ - Absolute path to the file
...
- `path` _string_ - Absolute path to the closed file
...
- `path` _string_ - Absolute path to the opened file
...
- `path` _string_ - Absolute path to the file to get symbols from
