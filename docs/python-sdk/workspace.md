...
* [workspace](#workspace)
  * [Workspace](#workspace.Workspace)
    * [get\_workspace\_root\_dir](#workspace.Workspace.get_workspace_root_dir)
    * [create\_lsp\_server](#workspace.Workspace.create_lsp_server)
...
#### `create_lsp_server(language_id: LspLanguageId, path_to_project: str)`
