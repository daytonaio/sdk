...
image = (
    Image.base("python:3.13.2-slim-bookworm").pip_install([ "matplotlib", "numpy", "scipy", "scikit-learn"])
    # .pip_install_from_pyproject("packages/python/pyproject.toml", optional_dependencies=["dev"])
    .run_commands("mkdir -p /home/daytona/ws3")
    .workdir("/home/daytona/ws3")
    .add_local_dir("packages/python", "/home/daytona/ws3/python-pkg")
)
