...
python3 -m pip install "aiohttp>=3.8.5" "pydantic>=2.4.2" "python-dateutil>=2.8.2" "typing-extensions>=4.7.1" "urllib3>=1.25.3" "isort>=5.10.0,<6.0.0" "nbqa>=1.9.1" "black[jupyter]>=25.1.0" "pylint>=3.3.4"
