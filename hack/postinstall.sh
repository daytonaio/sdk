...
python3 -m pip install "aiohttp>=3.8.5" "pydantic>=2.4.2" "python-dateutil>=2.8.2" "typing-extensions>=4.7.1" "urllib3>=1.25.3" "pydoc-markdown>=4.8.0" "isort>=5.10.0,<6.0.0" "nbqa>=1.9.1" "pylint>=3.3.4" "black[jupyter]>=23.1.0,<=23.12.1"
